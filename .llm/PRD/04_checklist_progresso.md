# Checklist de Progresso — DP-750

**Fonte canônica do conteúdo da trilha para o DeltaQuest.**
Plano de estudos da certificação **DP-750: Implementing Data Engineering Solutions
Using Azure Databricks**.

| | |
|---|---|
| **Candidato** | Igor Ferreira Rodrigues |
| **Início do estudo** | 22/06/2026 |
...
## Fase de simulados
**5 tarefas · meta: 09/09/2026 · alvo de nota: ≥ 85%**

- [ ] Simulado diagnóstico inicial
- [ ] Practice assessment oficial da Microsoft — rodada 1
- [ ] Revisar erros da rodada 1 e reforçar lacunas
- [ ] Practice assessment oficial da Microsoft — rodada 2
- [ ] Simulado final cronometrado (atingir ≥ 85%)

## Revisão final
**4 tarefas · semana 13**

- [ ] Revisar resumos dos 15 módulos
- [ ] Revisar flashcards/quizzes (NotebookLM)
- [ ] Revisão focada nas lacunas dos simulados
- [ ] Checklist do dia da prova (logística, ambiente, descanso)
